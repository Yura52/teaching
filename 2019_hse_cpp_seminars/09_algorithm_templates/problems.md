...
# 5.A
Если предыдущие задачи компилируются, сигнатура функции из 4F похожа на апокалипсис и желание перестать писать на С++ выросло на 1234%, то поздравляю, вы овладели очень важным и постоянно применяющимся на практике навыком. Пятерка в дневник и в журнал.
